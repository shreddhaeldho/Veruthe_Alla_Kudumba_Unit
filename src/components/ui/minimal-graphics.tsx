...
export function HandshakeIcon({ size = 24, className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="m14 14-1.5-1.5a1 1 0 0 0-1.4 0l-3.8 3.8a2 2 0 0 1-2.8 0 2 2 0 0 1 0-2.8l4.2-4.2a1 1 0 0 1 1.4 0l1.9 1.9" />
      <path d="M7 7.5 9 9.5" />
      <path d="m18 11.5 2 2" />
      <path d="m14.5 4.5-8 8" />
    </svg>
  );
}
...
export function TicketIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function PhoneDeviceIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UtensilsIcon({ size = 24, className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M15 2v18" />
      <path d="M6 2v8a3 3 0 0 0 3 3h1v7" />
    </svg>
  );
}
...
export function DicesIcon({ size = 24, className, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="m17.92 14 3.5-3.5a2.41 2.41 0 0 0 0-3.41l-4.5-4.5a2.41 2.41 0 0 0-3.41 0L10 6.08" />
      <path d="M6 14h.01" />
      <path d="M10 18h.01" />
    </svg>
  );
